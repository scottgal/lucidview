...
```bash
npm install @mostlylucid/naiad-mermaid
```
...
flowchart LR
  ...
  <script type="module" src="/node_modules/@mostlylucid/naiad-mermaid/dist/naiad-web-component.js"></script>
</body>
</html>
```
...
This package is the minimal Mermaid-equivalent profile and does not ship external skin-pack assets.
...
```html
<iframe src="/node_modules/@mostlylucid/naiad-mermaid/dist/all-diagrams-web-component.html"></iframe>
```
