...
Tests top-to-bottom flow with multiple subgraphs:
- Subgraph members stay at contiguous ranks
- Edges between subgraphs don't cross through other subgraph boxes
- Parallel nodes (same rank) are placed side-by-side
- Edge labels don't overlap subgraph boundaries
