...
| **7 themes** | Light, Dark, VS Code, GitHub, mostlylucid Dark, mostlylucid Light, **Pride**, plus user-defined Custom themes via `settings.json` |
...
| **Native visual Markdown canvas** | Compact Preview / Edit / Split controls; edit rendered native blocks in place, with no WebView |
| **Offline spellcheck** | Hunspell-powered spelling underlines and suggestions in the Markdown editor |
...
| `Ctrl+F` | Search |
| `Ctrl+S` | Save the current local Markdown file (or Save As for URL/generated documents) |
